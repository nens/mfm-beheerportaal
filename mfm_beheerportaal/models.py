...
class PhysicalLocationMixin(models.Model):
    ...
    latitude = models.DecimalField(
        _('Latitude'), default=0, max_digits=11, decimal_places=8)
    longitude = models.DecimalField(
        _('Longitude'), default=0, max_digits=11, decimal_places=8)
    altitude = models.DecimalField(
        _('Altitude'), default=0, max_digits=11, decimal_places=8)
...
class Multiflexmeter(PhysicalLocationMixin, models.Model):
    ...
    owner = models.ForeignKey(
        Organisation, on_delete=models.SET_NULL, null=True)
